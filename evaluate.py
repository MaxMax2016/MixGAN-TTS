...
def evaluate(args, model, discriminator, step, configs, logger=None, vocoder=None, losses=None):
    ...
    message = "Validation Step {}, Total Loss: {:.4f}, D_loss: {:.4f}, adv_loss: {:.4f}, mel_loss: {:.4f}, postnet_loss: {:.4f}, pitch_loss: {:.4f}, energy_loss: {:.4f}, duration_loss: {:.4f}, helper_loss: {:.4f}".format(
